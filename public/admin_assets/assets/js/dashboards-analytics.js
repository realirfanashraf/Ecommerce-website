...
let salesCountByMonth = JSON.parse(document.getElementById('salesCountByMonth').textContent);
...
salesCountByMonth.forEach((monthData)=>{
  ...
  switch(month){
    ...
    case 8:
      ...
      break;
    case 9:
      salesCountByMonthObj.Sept = count;
    case 10:
...
const salesCountMar = salesCountByMonthObj.March;
...
const salesCountSept = salesCountByMonthObj.Sept;
  ...
  const totalRevenueChartEl = document.querySelector('#totalRevenueChart'),
    totalRevenueChartOptions = {
      series: [
        {
          name: '2023',
          data: [salescountJan, salesCountFeb, salesCountMar,
                salesCountApril, salesCountMay, salesCountJune,
                salesCountJuly, salesCountAug, salesCountSept,
                salesCountOct, salesCountNov, salesCountDec]
        },
      ],
      chart: {
        height: 300,
